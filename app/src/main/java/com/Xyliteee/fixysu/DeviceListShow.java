...
public class DeviceListShow extends AppCompatActivity {
    ...
    public void KickDevice0(View view){
        String IP = devicesList[0].ipAddress;
        DownLine(IP);
    }
    public void KickDevice1(View view){
        String IP = devicesList[1].ipAddress;
        DownLine(IP);
    }
    public void KickDevice2(View view){
        String IP = devicesList[2].ipAddress;
        DownLine(IP);
    }
    public void KickDevice3(View view){
        String IP = devicesList[3].ipAddress;
        DownLine(IP);
    }
